  ...
  function s() {
    ...
    n.length > 0 &&
      ($(".be-toggle-right-sidebar").on("click", function(t) {
        r && i.hasClass(e.openRightSidebarClass)
          ? a()
          : r ||
            (i.addClass(e.openRightSidebarClass + " " + e.transitionClass),
            (r = !0)),
          t.preventDefault();
      }),
      $(document).on("mousedown touchstart", function(t) {
        !$(t.target).closest(n).length &&
          i.hasClass(e.openRightSidebarClass) &&
          (e.closeRsOnClickOutside || $.isSm()) &&
          a();
      })),
      t.perfectScrollbar(),
  ...
  function d() {
    ...
    function c(e, t) {
      ...
      "" != e &&
        ...
        i.appendTo(o),
        n.stop().animate({ scrollTop: n.prop("scrollHeight") }, 900, "swing"),
    ...
    init: function(u) {
      ...
      $.extend(e, u),
        ...
        (function() {
          ...
          a.hasClass(e.collapsibleSidebarClass) &&
            ((n = void 0 !== t ? t : $(".sidebar-elements > li", o)),
            $.each(n, function() {
              var e = $(this)
                  .find("> a span")
                  .html(),
              ...
              t.find("> li.title").length ||
                (t.prepend(e),
                i.appendTo(a.find(".content ul")),
                a.appendTo(t));
            }),
            $(".be-toggle-left-sidebar").on("click", function() {
              a.hasClass(e.collapsibleSidebarCollapsedClass)
                ? (a.removeClass(e.collapsibleSidebarCollapsedClass),
                  $("li.open", o).removeClass("open"),
                  $("li.active", o)
                    .parents(".parent")
                    .addClass("active open"),
                  $(".be-scroller", o).perfectScrollbar("destroy"))
                : (a.addClass(e.collapsibleSidebarCollapsedClass),
                  $("li.active", o)
                    .parents(".parent")
                    .removeClass("open"),
                  $("li.open", o).removeClass("open"));
            ...
            a.hasClass(e.collapsibleSidebarCollapsedClass)
              ...
              : $("li.active", o)
                  .parents(".parent")
                  .addClass("active open"),
            a.hasClass("be-fixed-sidebar") &&
              (($.isSm() && !a.hasClass(e.offCanvasLeftSidebarClass)) ||
                d.perfectScrollbar(),
              $(window).resize(function() {
                h(
                  function() {
            ...
            p.on("click", function(t) {
              ...
              $(this).toggleClass("open"),
                i.slideToggle(e.leftSidebarToggleSpeed, function() {
                  $(this)
                    .removeAttr("style")
                    .toggleClass("open");
                });
            }),
            a.hasClass(e.offCanvasLeftSidebarClass) &&
              (e.toggleLeftSidebarButton.on("click", function(t) {
                r && i.hasClass(e.openLeftSidebarClass)
                  ? (i.removeClass(e.openLeftSidebarClass), c())
                  : (i.addClass(
                      e.openLeftSidebarClass + " " + e.transitionClass
                    ),
                    (r = !0)),
                  t.preventDefault();
              }),
              $(document).on("mousedown touchstart", function(t) {
                $(t.target).closest(o).length ||
                  $(t.target).closest(e.toggleLeftSidebarButton).length ||
                  !i.hasClass(e.openLeftSidebarClass) ||
                  (i.removeClass(e.openLeftSidebarClass), c());
              }));
        })(),
        s(),
        ...
        e.scrollTop &&
          ((f = $('<div class="be-scroll-top"></div>')).appendTo("body"),
...
(FastClick.prototype.needsClick = function(e) {
  ...
  (FastClick.notNeeded = function(e) {
    ...
    if (
      ...
      (a = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/))[1] >= 10 &&
      a[2] >= 3 &&
  ...
  (function(e) {
        ...
        "object" == typeof o &&
          (T(o.r) && T(o.g) && T(o.b)
            ? ((u = o.r),
              ...
              (d = !0),
              (p = "%" === String(o.r).substr(-1) ? "prgb" : "rgb"))
            : T(o.h) && T(o.s) && T(o.v)
              ? ((l = S(o.s)),
                (s = S(o.v)),
                (n = (function(t, i, a) {
              ...
              : T(o.h) &&
                ...
                (n = (function(e, t, i) {
                  ...
                  var o, n, r;
                  if (
                    ((e = y(e, 360)), (t = y(t, 100)), (i = y(i, 100)), 0 === t)
                  )
                    o = n = r = i;
                  else {
    ...
    function i(e, t, i) {
      ...
      if (n == r) a = o = 0;
        ...
        var s = n - r;
        switch (((o = l > 0.5 ? s / (2 - n - r) : s / (n + r)), n)) {
          case e:
            a = (t - i) / s + (i > t ? 6 : 0);
            break;
          case t:
    ...
    function d(e, i) {
      ...
      var a = t(e).toRgb();
      return (
        (a.r = P(0, L(255, a.r - F(-i / 100 * 255)))),
        (a.g = P(0, L(255, a.g - F(-i / 100 * 255)))),
        (a.b = P(0, L(255, a.b - F(-i / 100 * 255)))),
        t(a)
      );
    }
    function p(e, i) {
    ...
    function f(e) {
      ...
      return [
        t(e),
        t({ h: (a + 120) % 360, s: i.s, l: i.l }),
        t({ h: (a + 240) % 360, s: i.s, l: i.l })
      ];
    }
    function g(e) {
      var i = t(e).toHsl(),
      ...
      return [
        t(e),
        t({ h: (a + 90) % 360, s: i.s, l: i.l }),
        t({ h: (a + 180) % 360, s: i.s, l: i.l }),
    ...
    function m(e) {
      ...
      return [
        t(e),
        t({ h: (a + 72) % 360, s: i.s, l: i.l }),
        t({ h: (a + 216) % 360, s: i.s, l: i.l })
      ];
    }
    function b(e, i, a) {
      (i = i || 6), (a = a || 30);
      var o = t(e).toHsl(),
        n = 360 / a,
        r = [t(e)];
      for (o.h = (o.h - ((n * i) >> 1) + 720) % 360; --i; )
        (o.h = (o.h + n) % 360), r.push(t(o));
      return r;
    }
    function v(e, i) {
      i = i || 6;
      for (
        var a = t(e).toHsv(), o = a.h, n = a.s, r = a.v, l = [], s = 1 / i;
        i--;

      )
        l.push(t({ h: o, s: n, v: r })), (r = (r + s) % 1);
      return l;
    }
    function k(e) {
    ...
    function y(t, i) {
      ...
      "string" == typeof (a = t) &&
        ...
        (t = "100%");
      var o,
        n = "string" == typeof (o = t) && -1 != o.indexOf("%");
      return (
        (t = L(i, P(0, parseFloat(t)))),
    ...
    (t.prototype = {
      ...
      getLuminance: function() {
        ...
        return (
          ...
          0.2126 *
            ...
            0.0722 *
              (0.03928 >= a ? a / 12.92 : e.pow((a + 0.055) / 1.055, 2.4))
        );
      },
      setAlpha: function(e) {
      ...
      toName: function() {
        return 0 === this._a
          ? "transparent"
          : !(this._a < 1) && (B[o(this._r, this._g, this._b, !0)] || !1);
      },
      toFilter: function(e) {
      ...
      (t.fromRatio = function(e, i) {
        if ("object" == typeof e) {
          var a = {};
          for (var o in e)
            e.hasOwnProperty(o) && (a[o] = "a" === o ? e[o] : S(e[o]));
          e = a;
        }
        return t(e, i);
      }),
      ...
      (t.readability = function(i, a) {
        var o = t(i),
          n = t(a);
        return (
          (e.max(o.getLuminance(), n.getLuminance()) + 0.05) /
          (e.min(o.getLuminance(), n.getLuminance()) + 0.05)
        );
      }),
      ...
      (t.mostReadable = function(e, i, a) {
        ...
        for (var d = 0; d < i.length; d++)
          (o = t.readability(e, i[d])) > c && ((c = o), (s = t(i[d])));
        return t.isReadable(e, s, { level: r, size: l }) || !n
          ? s
          : ((a.includeFallbackColors = !1),
            t.mostReadable(e, ["#fff", "#000"], a));
      });
    var D,
      R,
      O,
            ...
            ((_ = new function(t, T) {
                    ...
                    return (
                      ...
                      !s || Se === T.fingers || T.fingers === b || Y()
                        ? ((xe = ne()),
                          2 == Se &&
                            (Z(1, s[1]),
                            (me = be = ae(Ae[0].start, Ae[1].start))),
              ...
              function E(t) {
                ...
                if ($e !== w && $e !== C && !Q()) {
                  ...
                  if (
                    ((Te = ne()),
                    x && (Se = x.length),
                    T.hold && clearTimeout(Le),
                    ($e = y),
                    2 == Se &&
                      (0 == me
                        ? (Z(1, x[1]), (me = be = ae(Ae[0].start, Ae[1].start)))
                        : (K(x[1]),
                          (be = ae(Ae[0].end, Ae[1].end)),
                          Ae[0].end,
                          Ae[1].end,
                          (ye = ve < 1 ? l : r)),
                      (ve = (be / me * 1).toFixed(2)),
                      (ke = Math.abs(me - be))),
                    Se === T.fingers || T.fingers === b || !x || Y())
                  ) {
                    if (
                      ((he = oe(E.start, E.end)),
                      (fe = oe(E.last, E.end)),
                      ...
                      (ue = Math.round(
                        Math.sqrt(
                          Math.pow($.x - k.x, 2) + Math.pow($.y - k.y, 2)
                        )
                      )),
                      (ge = ie()),
                      (v = ue),
                      (f = he) != s &&
                        ((v = Math.max(v, ee(f))), (we[f].distance = v)),
                      (A = D(S, $e)),
                      ...
                      !T.triggerOnTouchEnd && M
                        ? ($e = I(y))
                        : T.triggerOnTouchLeave && !M && ($e = I(w)),
                        ($e != C && $e != w) || D(S, $e);
                    }
                  } else D(S, ($e = C));
                  !1 === A && D(S, ($e = C));
              ...
              function M(e) {
                ...
                if (a) {
                  if (a.length && !Q())
                    return (
                      (t = i), (_e = ne()), (Ee = t.touches.length + 1), !0
                    );
                ...
                return (
                  !i || o
                    ...
                    : !a ||
                      e != y ||
                      (T.triggerOnTouchEnd && !T.triggerOnTouchLeave)
                      ? !a && e == w && T.triggerOnTouchLeave && (t = C)
                      : (t = w),
                  t
                );
              }
              function D(e, t) {
                ...
                return (
                  ...
                  G() && U() && !1 !== i
                    ? (i = R(e, t, h))
                    : ge > T.longTapThreshold && ue < v && T.longTap && !1 !== i
                      ? (i = R(e, t, f))
                      : !(
                          (1 !== Se && $) ||
                          !(isNaN(ue) || ue < T.threshold) ||
                          !X()
                        ) &&
                        !1 !== i &&
                        (i = R(e, t, u)),
                ...
                if (c == d) {
                  ...
                  if (s == w && z()) {
                    if (
                      (clearTimeout(Fe),
                      clearTimeout(Le),
                      Ce.trigger("swipe", [he, ue, ge, Se, Ae, fe]),
                      T.swipe &&
                        !1 ===
                          (g = T.swipe.call(Ce, t, he, ue, ge, Se, Ae, fe)))
                    )
                      return !1;
                    switch (he) {
                      case i:
                      ...
                      case o:
                        Ce.trigger("swipeUp", [he, ue, ge, Se, Ae, fe]),
                          T.swipeUp &&
                            (g = T.swipeUp.call(Ce, t, he, ue, ge, Se, Ae, fe));
                        break;
                      case n:
              ...
              function J(e) {
                Ce &&
                  (!0 === e
                    ? (Ce.bind(se, E), Ce.bind(ce, M), de && Ce.bind(de, L))
                    : (Ce.unbind(se, E, !1),
                      Ce.unbind(ce, M, !1),
                      de && Ce.unbind(de, L, !1)),
                  Ce.data(x + "_intouch", !0 === e));
              }
              function Z(e, t) {
                var i = {
                  start: { x: 0, y: 0 },
              ...
              try {
                ...
                e.error(
                  "events not supported " + le + "," + pe + " on jQuery.swipe"
                );
              }
  ...
  (function(e) {
    (e.isBreakpoint = function(t) {
      ...
      return (
        (a = (i = e("<div/>", { class: o }).appendTo("body")).is(":hidden")),
        i.remove(),
        a
      );
    }),
            ...
            datasets: [
              {
                ...
                backgroundColor: o.setAlpha(0.8).toString(),
                data: [x(), x(), x(), x(), x(), x(), x()]
              },
              {
                label: "Debit",
                borderColor: n.toString(),
                backgroundColor: n.setAlpha(0.5).toString(),
                data: [x(), x(), x(), x(), x(), x(), x()]
              }
            ]
          }),
    ...
    return (
      (App.chartsSparklines = function() {
        ...
        ($.fn.sparkline.defaults.common.lineColor = e),
          ($.fn.sparkline.defaults.common.fillColor = o
            .setAlpha(0.3)
            .toString()),
          ...
          ($.fn.sparkline.defaults.bullet.rangeColors[0] = n
            .setAlpha(0.2)
            .toString()),
          ($.fn.sparkline.defaults.bullet.rangeColors[1] = n
            .setAlpha(0.5)
            .toString()),
          ($.fn.sparkline.defaults.bullet.rangeColors[2] = n
            .setAlpha(0.45)
            .toString()),
          ...
          ($.fn.sparkline.defaults.box.boxFillColor = n
            .setAlpha(0.5)
            .toString()),
      ...
      (App.charts = function() {
        ...
        function t(e, t) {
          $("#" + e).bind("plothover", function(e, i, a) {
            ...
            a
              ? $(".tooltip-chart")
                  .css({ top: a.pageY - t, left: a.pageX - o / 2 })
                  .fadeIn(200)
              : $(".tooltip-chart").hide();
          });
        }
      ...
      (App.dashboard = function() {
        ...
        $('[data-toggle="counter"]').each(function(e, t) {
          ...
          i.data("prefix") && (a = i.data("prefix")),
            ...
            new CountUp(i.get(0), n, r, l, s, { suffix: o, prefix: a }).start();
        }),
          ...
          $("#main-chart").bind("plothover", function(e, t, i) {
            ...
            i
              ? $(".tooltip-chart")
                  .css({ top: i.pageY - o, left: i.pageX - a / 2 })
                  .fadeIn(200)
              : $(".tooltip-chart").hide();
          }),
          $('[data-color="main-chart-color1"]').css({ "background-color": n }),
    ...
    return (
      (App.pageProfile = function() {
        ...
        (t = App.color.primary),
          ...
          (e = 60),
          $("#bar-chart1").bind("plothover", function(t, i, a) {
            var o = $(".tooltip-chart").width();
            a
              ? $(".tooltip-chart")
                  .css({ top: a.pageY - e, left: a.pageX - o / 2 })
                  .fadeIn(200)
              : $(".tooltip-chart").hide();
          });
      }),
  ...
  (App = (function() {
    ...
    return (
      (App.tableFilters = function() {
        $(".bslider").bootstrapSlider({ tooltip: "hide" }),
          $("#milestone_slider")
            .slider()
            .on("slide", function(e) {
              var t = e.value[0],
