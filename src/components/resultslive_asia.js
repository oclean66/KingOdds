        ...
        <div className="cold-sm-12">
            <div className="tab-content">
                ...
                <div id="AM-Football" className="tab-pane fade">
                    <div className="table-responsive-lg" style={{border:'1px solid deepskyblue'}}>
                    <iframe title="tile558" id="inscore-xdc-619558" src="http://www.livescore.in/free/619558/" width="624" height="500" frameborder="0" scrolling="no"></iframe>                    </div>
                </div>
                <div id="Handball" className="tab-pane fade">
                    <div className="table-responsive-lg" style={{border:'1px solid deepskyblue'}}>
                    <iframe title="tile590" id="inscore-xdc-192590" src="http://www.livescore.in/free/192590/" width="624" height="500" frameborder="0" scrolling="no"></iframe>                    </div>
                </div>
                <div id="Volleyball" className="tab-pane fade">
                    <div className="table-responsive-lg" style={{border:'1px solid deepskyblue'}}>
                    <iframe title="tile845" id="inscore-xdc-203845" src="http://www.livescore.in/free/203845/" width="624" height="500" frameborder="0" scrolling="no"></iframe>                </div>
                <div id="RugbyU" className="tab-pane fade">
                    <div className="table-responsive-lg" style={{border:'1px solid deepskyblue'}}>
                    <iframe title="tile281" id="inscore-xdc-710281" src="http://www.livescore.in/free/710281/" width="624" height="500" frameborder="0" scrolling="no"></iframe>                    </div>
                </div>
                <div id="Cricket" className="tab-pane fade">
                    <div className="table-responsive-lg" style={{border:'1px solid deepskyblue'}}>
                    <iframe title="tile750" id="inscore-xdc-733750" src="http://www.livescore.in/free/733750/" width="624" height="500" frameborder="0" scrolling="no"></iframe>                    </div>
                </div>
